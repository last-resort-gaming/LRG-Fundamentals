/*
Function: LR_fnc_LimitedArsenal
...
Examples:
	(begin example)
		[this] call LR_fnc_LimitedArsenal;
		[this, "3CB", 50] call LR_fnc_LimitedArsenal;
		[this, "VANILLA"] call LR_fnc_LimitedArsenal;
		[MyAmmoCrate, "RHS", 0] call LR_fnc_LimitedArsenal;
	(end)
