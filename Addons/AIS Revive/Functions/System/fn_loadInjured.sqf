...
[[_injured, _vehicle, 1], {_this call LRG_AIS_System_fnc_moveCargoRemote}] remoteExec ["call"];

// unconscious animation in cargo seat
[{[(_this select 0), 'unconscious'] remoteExec ["playActionNow", 0, false]}, [_injured]] call LRG_AIS_Core_fnc_onNextFrame;
