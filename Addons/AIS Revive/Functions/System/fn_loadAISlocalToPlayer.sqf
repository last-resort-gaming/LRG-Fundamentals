...
_unit addEventHandler ["HandleDamage", {_this call LRG_AIS_Damage_fnc_handleDamage}];

_unit removeAllEventHandlers "Killed";
_unit addEventHandler ["Killed", {_this call LRG_AIS_System_fnc_killed}];

_unit removeAllEventHandlers "Respawn";
if ([_unit] call LRG_AIS_Core_fnc_isPlayable) then {
	_unit addEventHandler ["Respawn", {_this call LRG_AIS_System_fnc_respawn}];
};

_unit addEventHandler ["HandleHeal", {_this call LRG_AIS_System_fnc_handleHeal}];
