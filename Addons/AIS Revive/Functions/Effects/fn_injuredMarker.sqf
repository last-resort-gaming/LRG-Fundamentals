...
* Exapmle:
	player call LRG_AIS_Effects_fnc_injuredMarker
 */
...
_mark = [_marker, position _unit, "ICON", "Color1_FD_F", [0.7, 0.7], format ["%1 down", _str], 0, "loc_Hospital"] call LRG_AIS_Core_fnc_createLocalMarker;
