...
class LRG_CC_RscStructuredText
{
	deletable = 0;
	fade = 0;
	type = 13;
...
class LRG_CC_RscShortcutButton
{
	deletable = 0;
	fade = 0;
	type = 16;
...
class LRG_CC_RscShortcutButtonMain
{
	idc = -1;
	style = 0;
	default = 0;
